...
from decmk.model.copter import Copter_linear
from decmk.agents.ISMC import IntegralSMC_linear
...
class Env(BaseEnv):
    def __init__(self):
        ...
        self.controller = IntegralSMC_linear(self.plant.J,
                                             self.plant.m,
                                             self.plant.g,
                                             self.plant.d,
                                             ic,
    ...
    def get_ref(self, t, x):
        ...
        pos_des = np.vstack((1*cos(t), 1*sin(t), -t))
        vel_des = np.vstack((-1*sin(t), 1*cos(t), -1))
    ...
    def _get_derivs(self, t, x, p):
        ...
        forces, sliding = self.controller.get_FM(x, ref, p, K, Kc, PHI, t)
    ...
    def set_dot(self, t):
        ...
        *_, rotors, ref, sliding = self._get_derivs(t, x, p)
    ...
    def logger_callback(self, i, t, y, *args):
        ...
        *_, rotors, ref, sliding = self._get_derivs(t, x_flat, p)
        return dict(t=t, **states, rotors=rotors, ref=ref, s=sliding)
...
def exp1_plot():
    ...
    ax3.plot(data['t'], data['plant']['angle'].squeeze())
    ...
    ax3.set_ylabel('Euler angle [rad]')
